package openSolutions.currencyJournal.service;

import lombok.RequiredArgsConstructor;
import openSolutions.currencyJournal.dto.*;
import openSolutions.currencyJournal.entity.*;
import openSolutions.currencyJournal.mapper.RateMapper;
import openSolutions.currencyJournal.parser.CbrXmlParser;
import openSolutions.currencyJournal.repository.*;
...
public class CurrencyRateService {
    ...
    public Page<RateDto> getRates(String currencyId, Long countryId, Long rateDictId,
                                  LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
        log.debug("Запрос журнала курсов: currencyId={}, countryId={}, rateDictId={}, startDate={}, endDate={}",
                currencyId, countryId, rateDictId, startDate, endDate);
